...
Historical green results are supporting history only. The exact review/main SHA being accepted must independently pass PHP 7.4/8.3 quality, all current and retained regression/review gates, two fresh post-code reviews, baseline integrity, deterministic ZIP, SHA-256 and file-level SBOM. After merge, fresh post-merge exact-main acceptance remains mandatory.
...
Historical ninth cycle remains `docs/REVIEW-10-NINTH-LEDGER-v1.4.7.md`. Current record: `docs/REVIEW-20-TENTH-LEDGER-v1.4.8.md`. Earlier review ledgers remain supporting evidence.
