...
s7(false!==strpos($main,'Version: 1.4.5')&&false!==strpos($main,"GCU_VERSION', '1.4.5'")&&false!==strpos($main,"GCU_SCHEMA_VERSION', 10005"),'Seventh-review release/schema identity drift.');
