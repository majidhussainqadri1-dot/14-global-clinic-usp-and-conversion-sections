...
sr_check( '' !== $version && false !== strpos( $trace, 'Requirements Traceability — v' . $version ) && false !== strpos( $trace, 'File 14 v' . $version . ' may only claim a status' ) && false !== strpos( $trace_addendum, 'Requirements Traceability Addendum — v1.4.5' ), 'Current traceability or v1.4.5 corrective delta trace is missing.' );
