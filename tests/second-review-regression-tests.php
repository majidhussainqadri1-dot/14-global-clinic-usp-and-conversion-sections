...
sr_check( false !== strpos( $rest, 'public_destination_health()' ) && false !== strpos( $rest, "public function destinations(){if(!get_option('gcu_enabled',1))" ), 'Public destinations endpoint is not safe-D​​TO/safe-mode bounded.' );
