...
need "Stable tag: 1.4.5" "$P/readme.txt"
...
echo "Fresh Review Round 2: PASS — privacy, consent, localization, RTL/LTR, File20 shell ownership, accessibility, low-data, ethical conversion, multilingual AI safety, dark-pattern guardrails, small-cohort privacy, packaging, repository hygiene, uninstall and truth-status controls"
