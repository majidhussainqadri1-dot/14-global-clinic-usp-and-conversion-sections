...
need "Stable tag: 1.4.6" "$P/readme.txt"
...
need "eighth-review-regression-tests.php" "$ROOT/scripts/quality.sh"
need "REVIEW-10-EIGHTH-LEDGER-v1.4.6.md" "$ROOT/scripts/quality.sh"
...
echo "Fresh Review Round 2: PASS — privacy, consent, localization, RTL/LTR, File20 shell ownership, accessibility, low-data, ethical conversion, multilingual AI safety, source hygiene, release evidence and truth-status controls"
