...
need "Version: 1.4.4" "$P/global-clinic-usp-integration.php"
...
echo "Fresh Review Round 1: PASS — architecture, runtime schema truth, canonical ownership, authorization, migration, concurrency, trust governance, reliability, queues, audit and destination fail-closed controls"
