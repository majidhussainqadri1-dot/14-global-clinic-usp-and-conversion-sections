...
php "$ROOT/tests/twelfth-cycle-round01-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round02-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round03-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round04-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round05-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round06-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round07-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round08-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round12-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round13-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round14-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round17-regression-tests.php"
php "$ROOT/tests/twelfth-cycle-round18-regression-tests.php"
...
for temp in "$ROOT/.github/workflows/file14-third-review-corrective-patch.yml" "$ROOT/scripts/apply-file14-third-review-corrections.py" "$ROOT/scripts/apply-file14-third-review-deep-corrections.py" "$ROOT/scripts/apply-file14-third-review-final-corrections.py" "$ROOT/scripts/apply-file14-third-review-containment.py" "$ROOT/.github/workflows/file14-ninth-review-apply.yml" "$ROOT/scripts/apply-file14-ninth-review-corrections.py" "$ROOT/.github/workflows/file14-round20-apply.yml" "$ROOT/scripts/round20-admin-reports-fix.py" "$ROOT/scripts/round20-report-read-fix.py" "$ROOT/scripts/round20-report-reliability-fix.py" "$ROOT/.github/workflows/file14-review12-round02-apply.yml" "$ROOT/scripts/apply-review12-round02-auth.py" "$ROOT/.github/workflows/file14-review12-round03-apply.yml" "$ROOT/scripts/apply-review12-round03-route.py" "$ROOT/.github/workflows/file14-review12-round04-apply.yml" "$ROOT/scripts/apply-review12-round04-inputs.py"; do if [ -e "$temp" ]; then echo "Temporary corrective machinery remains: $temp" >&2; exit 1; fi; done
