...
for temp in "$ROOT/.github/workflows/file14-third-review-corrective-patch.yml" "$ROOT/scripts/apply-file14-third-review-corrections.py" "$ROOT/scripts/apply-file14-third-review-deep-corrections.py" "$ROOT/scripts/apply-file14-third-review-final-corrections.py" "$ROOT/scripts/apply-file14-third-review-containment.py" "$ROOT/.github/workflows/file14-ninth-review-apply.yml" "$ROOT/scripts/apply-file14-ninth-review-corrections.py" "$ROOT/.github/workflows/file14-round20-apply.yml" "$ROOT/scripts/round20-admin-reports-fix.py" "$ROOT/scripts/round20-report-read-fix.py" "$ROOT/scripts/round20-report-reliability-fix.py" "$ROOT/.github/workflows/file14-review12-round02-apply.yml" "$ROOT/scripts/apply-review12-round02-auth.py" "$ROOT/.github/workflows/file14-review12-round03-apply.yml" "$ROOT/scripts/apply-review12-round03-route.py"; do if [ -e "$temp" ]; then echo "Temporary corrective machinery remains: $temp" >&2; exit 1; fi; done
