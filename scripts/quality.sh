...
python3 -m py_compile "$ROOT/scripts/build.py" "$ROOT/scripts/review80.py" "$ROOT/scripts/review80-second.py" "$ROOT/scripts/review80-third.py" "$ROOT/scripts/review80-fourth.py" "$ROOT/scripts/review80-fifth.py"
