...
r12r06_assert( false !== strpos( $policy, "array_merge( $dark['flags'], $business['flags'], $semantic['flags'] )" ), 'Copy preflight must include business-policy contradiction flags.' );
