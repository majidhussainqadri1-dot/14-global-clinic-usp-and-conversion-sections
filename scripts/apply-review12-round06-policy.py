...
r12r06_assert( false !== strpos( $policy, 'business_policy' ) && false !== strpos( $policy, "self::business_policy_contradiction_scan( $current )" ), 'Copy preflight must include business-policy contradiction flags.' );
